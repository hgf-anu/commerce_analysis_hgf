...
object ConfigurationManager{
	...
	private val builder:FileBasedConfigurationBuilder[FileBasedConfiguration] = new FileBasedConfigurationBuilder[FileBasedConfiguration](
		classOf[PropertiesConfiguration] ).configure( params.properties().setFileName( "commerce.properties" ) )
